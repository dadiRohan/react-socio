                        ...
                        <div className="relative flex flex-col my-6 bg-white shadow-sm border border-slate-400 rounded-lg w-4/6">      
                            ...
                            <div className="p-4">
                                ...
                                <div className="text-slate-600 leading-normal font-light">
                                    ...
                                    onClick={() => {
                                        const loggloggedUserId = localStorage.getItem("loggedUserId");
                                        const likePath = `${projectURL}likes/create`;
                                        fetch(likePath, {
                                            method: 'POST',
                                            headers: {
                                            ...
                                            body: JSON.stringify({ post_id: data?._id , user_id: loggloggedUserId })
                                        })
                                    ...
                                    >
                                        ...
                                        <span><ListLike postId={data?._id}/></span>
                                    </button>
